...
import {
  ...
  HeartPulse, TestTube, Pill, TrendingUp, Landmark
} from "lucide-react";
      ...
      <Card className="border-2 border-dashed border-accent/40 bg-gradient-to-br from-card to-accent/5 overflow-hidden relative">
        <CardHeader className="pb-2">
          ...
          <p className="text-xs text-muted-foreground">
            The accountability bridge connecting strategic funders to strategic purchasers — ensuring every naira and dollar is tied to measurable malaria outcomes.
          </p>
        </CardHeader>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 md:grid-cols-7 gap-3 items-start">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                {[
                  { name: "Global Fund", amount: "$1.2B", type: "Multilateral" },
                  { name: "PMI/USAID", amount: "$820M", type: "Bilateral" },
                  { name: "Gates Foundation", amount: "$340M", type: "Philanthropic" },
                  { name: "FGN Domestic", amount: "$158M", type: "Government" },
                  { name: "World Bank / IDA", amount: "$280M", type: "Development" },
                ].map((funder) => (
                  <motion.div
                    key={funder.name}
              ...
              <div className="md:col-span-3 flex flex-col items-center gap-3">
                <svg className="hidden md:block w-full h-6" viewBox="0 0 300 24">
                  <defs>
                    <marker id="arr-r" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="hsl(var(--accent))" /></marker>
                    <marker id="arr-r2" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="hsl(var(--secondary))" /></marker>
                  </defs>
                  <line x1="10" y1="8" x2="140" y2="8" stroke="hsl(var(--accent))" strokeWidth="1.5" strokeDasharray="4 2" markerEnd="url(#arr-r)" opacity="0.6" />
                  <text x="75" y="7" textAnchor="middle" fill="hsl(var(--accent))" fontSize="5" opacity="0.7">Funding Flows</text>
                  <line x1="160" y1="8" x2="290" y2="8" stroke="hsl(var(--secondary))" strokeWidth="1.5" strokeDasharray="4 2" markerEnd="url(#arr-r2)" opacity="0.6" />
                ...
                <svg className="hidden md:block w-full h-6" viewBox="0 0 300 24">
                  <defs>
                    <marker id="arr-l" markerWidth="6" markerHeight="6" refX="1" refY="3" orient="auto"><path d="M6,0 L0,3 L6,6 Z" fill="hsl(var(--accent))" /></marker>
                    <marker id="arr-l2" markerWidth="6" markerHeight="6" refX="1" refY="3" orient="auto"><path d="M6,0 L0,3 L6,6 Z" fill="hsl(var(--secondary))" /></marker>
                  </defs>
                  <line x1="140" y1="15" x2="10" y2="15" stroke="hsl(var(--accent))" strokeWidth="1" strokeDasharray="3 2" markerEnd="url(#arr-l)" opacity="0.5" />
                  <text x="75" y="13" textAnchor="middle" fill="hsl(var(--muted-foreground))" fontSize="4.5" opacity="0.7">Accountability Reports</text>
                  <line x1="290" y1="15" x2="160" y2="15" stroke="hsl(var(--secondary))" strokeWidth="1" strokeDasharray="3 2" markerEnd="url(#arr-l2)" opacity="0.5" />
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                {[
                  { name: "NMEP", role: "National purchasing & allocation", coverage: "36 States + FCT" },
                  { name: "State Malaria Programs", role: "Subnational procurement", coverage: "774 LGAs" },
                  { name: "NPHCDA", role: "Primary care commodities", coverage: "30,000+ PHCs" },
                  { name: "Private Sector (PPMVs)", role: "Last-mile drug distribution", coverage: "8,247 outlets" },
                  { name: "Community Health", role: "iCCM & SMC delivery", coverage: "54M children" },
                ].map((purchaser) => (
                  <motion.div
                    key={purchaser.name}
                    className="rounded-lg border border-secondary/30 bg-secondary/5 px-3 py-2"
